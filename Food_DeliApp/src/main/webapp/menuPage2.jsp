...
<link rel="stylesheet" href="menuN.css">
<meta charset="UTF-8">
<title>Bite Birst</title>
</head>
<body>
	<header>
		<div class="nav">
		...
		<div class="head">
			<h3>50% off</h3>
			<h3>Tastey food in your hand</h3>
		</div>
		<div class="header-image">
			<img
				src="https://images.unsplash.com/photo-1615719413546-198b25453f85?q=80&w=1936&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D.jpg">
		</div>
	</header>
	<!-- dynamic part-->
	<section class="sec-1">
		...
		%>
		<div class="box">
			<div class="white"> <img src="<%=menuItem.getImagePath()%>" alt="Menu Item Image">
				...
				<form class="form-add-to-cart" action="AddToCartServlet"
					method="post">
					<input type="hidden" name="itemId"
						value="<%=menuItem.getMenuID()%>">
					<!-- Update name to "itemId" -->
					<!--Quantity--> 
					...
					<!-- Hidden field for menu ID -->
					 <input type="hidden"name="itemImage" value="<%=menuItem.getImagePath()%>">
